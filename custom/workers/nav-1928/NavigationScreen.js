...
export default class NavigationScreen {
  ...
  initScene() {
    ...
    this.loadingManager.onLoad = () => {
      setTimeout(() => {
        console.log('1928LOADED!', (Date.now()-startTime)/1000, this.hasReceivedFirstUpdate );
    ...
    this.hotel1886Texture = new TextureLoader(this.loadingManager).load('/media/thf-1886.png');
    this.disposables.push(this.hotel1886Texture);
    ...
    this.material = new THREE.ShaderMaterial({
      uniforms: {
        ...
        tex1: { type:'t', value: this.hotel1886Texture },
        tex2: { type:'t', value: this.hotel1928Texture },
      },
